...
class CelebADataset(Dataset):
    ...
    def download(self):
        ...
        if not os.path.isdir(celeba_dir):
            ...
            extract_archive(os.path.join(celeba_dir, "celeba.zip"))
            url = (
...
class CelebADataModule:
    ...
    def setup(self):
        self.train_dataset = CelebADataset(self.root, split='train', transform=self.augmented_transforms())
        self.val_dataset = CelebADataset(self.root, split='val', transform=self.default_transforms())
        self.test_dataset = CelebADataset(self.root, split='test', transform=self.default_transforms())
