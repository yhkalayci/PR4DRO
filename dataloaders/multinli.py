...
class MultiNLIDataModule:
    ...
    def setup(self):
        self.train_dataset = MultiNLIDataset(self.root, split='train')
        self.val_dataset = MultiNLIDataset(self.root, split='val')
        self.test_dataset = MultiNLIDataset(self.root, split='test')
